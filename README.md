<div align="center">
  <img src="./banner.png" alt="Guilherme Kaleb — Software Engineer" width="100%" />
</div>
...
[![Portfolio](https://img.shields.io/badge/Portfolio-050505?style=for-the-badge&logo=firefox&logoColor=E50914)](https://portfolio-gk-fb10c.web.app/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A0A0A?style=for-the-badge&logo=linkedin&logoColor=0A66C2)](https://www.linkedin.com/in/guilherme-kaleb-a68a24258/)
[![Email](https://img.shields.io/badge/Email-0A0A0A?style=for-the-badge&logo=maildotru&logoColor=E50914)](mailto:guilhermekaleb04@outlook.com)
[![Profile Views](https://komarev.com/ghpvc/?username=GuilhermeKaleb&style=for-the-badge&color=E50914&label=VISITORS)](https://github.com/GuilhermeKaleb)
...
const guilherme = {
  ...
  focus: ["AI Engineering", "Full Stack Development", "Developer Tools"],
  location: "Goiânia, Goiás — Brazil 🇧🇷",
  education: "B.Sc. Systems Analysis & Development @ PUC-GO (2027)",
  currentlyBuilding: "AI-powered systems and automation platforms",
  goal: "Building products that solve real-world problems",
};
```

I'm a **Software Engineering student** passionate about building scalable software, developer tools and AI-powered applications. I enjoy transforming ideas into real products — from backend architectures and dashboards to automation platforms and developer frameworks.

Right now I'm focused on **software architecture, AI engineering, distributed systems** and shipping things that matter.

- 🎯 &nbsp;Currently learning **Software Architecture · AI Engineering · Distributed Systems**
- 🧠 &nbsp;Deepening **TypeScript · React · Fastify · Docker · PostgreSQL · Cloud**
- 🏎️ &nbsp;Outside code: software engineering, tech, **Formula 1**, cars, and leveling up my English
- 🍁 &nbsp;Preparing for a future career in **Canada**
...
## <img src="https://media.giphy.com/media/W5eDy1Xl0KYt6QNbLW/giphy.gif" width="26"> &nbsp;Featured Projects
...
### ⚡ GK Framework
An engineering framework that turns AI coding assistants into structured software engineering partners through **governance, memory and standardized workflows**.

`Node.js` · `CLI` · `Markdown` · `AI Engineering` · `DX`

</td>
<td width="50%" valign="top">

### 📊 SIGVIAS Monitoring
Monitoring platform for traffic enforcement equipment featuring **dashboards, automation and operational management**.

`React` · `Fastify` · `SQLite` · `PostgreSQL`
...
### 📈 Dashboard Pro
Modern dashboard focused on **real-time monitoring** and business metrics.
...
### 🤖 Automation Platform
Internal automation platform designed to **optimize repetitive operational workflows**.
...
### 🎬 Personal Portfolio
Developer portfolio built with modern web tech, inspired by **cinematic UI design**.

`Next.js` · `React` · `Framer Motion` · `Tailwind`

[**→ Live site**](https://portfolio-gk-fb10c.web.app/)

</td>
<td width="50%" valign="top">

### 🔒 More coming soon
Several projects are currently **private** while in active development.
Links will be added here as they go public.
...
[![Portfolio](https://img.shields.io/badge/View_My_Portfolio-E50914?style=for-the-badge&logoColor=white)](https://portfolio-gk-fb10c.web.app/)
[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/guilherme-kaleb-a68a24258/)

<sub><i>"Building products that solve real-world problems."</i></sub>
